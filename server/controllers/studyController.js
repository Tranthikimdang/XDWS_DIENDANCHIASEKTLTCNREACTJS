...
exports.getAllStudyTimes = async (req, res) => {
    try {
        ...
        res.status(500).send({
            status: 'error',
            message: err.message || 'Some error occurred while retrieving study times.'
        });
    }
};
...
exports.createStudyTime = async (req, res) => {
    ...
    try {
        ...
        res.status(500).send({
            status: 'error',
            message: err.message || 'Some error occurred while creating the study time.'
        });
    }
};
...
exports.updateStudyTime = async (req, res) => {
    ...
    try {
        ...
        res.status(500).send({
            status: 'error',
            message: err.message || 'Some error occurred while updating the study time.'
        });
    }
};
...
exports.deleteStudyTime = async (req, res) => {
    ...
    try {
        ...
        res.status(500).send({
            status: 'error',
            message: err.message || 'Some error occurred while deleting the study time.'
        });
    }
};
