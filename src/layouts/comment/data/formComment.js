      ...
      <div className='container'>
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div>
            ...
            <input className='form-control' type='email' {...register('email', { required: true, pattern: /^\S+@\S+$/i })} />
          ...
          <div>
            ...
            <textarea className='form-control' {...register('comment', { required: true, minLength: 10, maxLength: 500 })}></textarea>
