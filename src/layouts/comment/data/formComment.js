    ...
    <DashboardLayout>
      ...
      <div className='container'>
        <form onSubmit={handleSubmit(onSubmit)}>
          <div>
            <label className='text-light form-label' style={smallFontStyle}>Author</label>
          ...
          <div>
            <label className='text-light form-label' style={smallFontStyle}>Function</label>
          ...
          <div className='mt-3'>
            ...
            <Link to="/comment">
              <button className='text-light btn btn-outline-secondary ms-2' type="button">Back</button>
            </Link>
          </div>
        </form>
      </div>
