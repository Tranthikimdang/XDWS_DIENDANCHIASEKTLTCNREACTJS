...
import authorsProductData from "layouts/product/data/authorsProduct";
        ...
        <VuiBox mb={3}>
          <Card>
            <VuiBox display="flex" justifyContent="space-between" alignItems="center" mb="22px">
              ...
              <Link to="/formaddpro">
                <button className='text-light btn btn-outline-info' onClick={handleAddProductSuccess}>
                  <svg
                      ...
                      return {
                        ...
                        action: (
                          <div className="action-buttons">
                            ...
                            <Link to={{ pathname: "/formeditpro", state: { data: row } }}>
