...
// @mui material src/components/admin
import Fade from "@mui/material/Fade";

// Vision UI Dashboard React src/components/admin
import VuiBox from "src/components/admin/VuiBox";

// Custom styles for the VuiAlert
import VuiAlertRoot from "src/components/admin/VuiAlert/VuiAlertRoot";
import VuiAlertCloseIcon from "src/components/admin/VuiAlert/VuiAlertCloseIcon";
