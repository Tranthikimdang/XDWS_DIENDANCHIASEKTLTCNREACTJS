  ...
  useEffect(() => {
    const fetchFriends = async () => {
      ...
      try {
        ...
        const friendsList = followData.filter(
          (follow) =>
            (follow.follower_id === userId || follow.target_id === userId) &&
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} sx={{ marginBottom: { xs: '50px', md: '50px' }, marginTop: '30px' }}>
            ...
            <Typography variant="body1" paragraph className="typography-body">
              Bạn đã kết nối với những người bạn thân thiện, sẵn sàng hỗ trợ bạn trong hành trình
              học lập trình.
              <br />
              Những người bạn của chúng tôi là các chuyên gia giàu kinh nghiệm, luôn đồng hành cùng
              bạn trong việc phát triển sự nghiệp.
            </Typography>
          </Grid>
