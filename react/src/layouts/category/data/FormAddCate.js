...
//             <input className={`form-control bg-dark text-light`}style={smallFontStyle} {...register('name', { required: true, minLength: 3 })} />
//             {errors.name && <span className='text-danger'>{errors.name.message}</span>}
//             {errors.name && errors.name.type === 'required' && <span className='text-danger'style={smallFontStyle}>Categoryis required</span>}
//           </div>
