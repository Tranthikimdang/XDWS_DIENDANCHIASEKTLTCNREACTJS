  ...
  rows: [
    {
      ...
      content: (
        <Content content="React là một thư viện JavaScript mã nguồn mở được sử dụng để xây dựng giao diện người dùng, đặc biệt là các ứng dụng web đơn trang (Single Page Applications - SPA). React được phát triển và duy trì bởi Facebook, cùng với một cộng đồng các nhà phát triển cá nhân và công ty." />
      ),
      action: (
        <div>
